...
- **Notes:** Publishing can proceed non-interactively with `git push -u origin main`. Test verification now uses the checked-in synthetic fixture `GenericAcroFormFixture.pdf` at the repo root.
