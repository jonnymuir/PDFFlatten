...
| Testing | Robbie | Write tests, find edge cases, verify fixes |
| Scope & priorities | Impa | What to build next, trade-offs, decisions |
...
| Label | Action | Who |
|-------|--------|-----|
| `squad` | Triage: analyze issue, assign `squad:{member}` label | Impa |
